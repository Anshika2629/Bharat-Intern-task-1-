        ...
        <div className='run'>
            <div className=' first-section' >
                <div className="first-section-container">
                    ...
                    <div>
                        <img className='log1' src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Logonetflix.png" alt='logo' />
                    </div>
                ...
                <div className='center-info text-white '>
                    ...
                    <div className="input-box">
                        ...
                        <input type="text" className='shadow text-white mx-2' placeholder='Email address' />
                        <button>
